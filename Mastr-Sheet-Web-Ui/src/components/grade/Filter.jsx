...
export default function Filter() {
  ...
  const handleSubmit = async () => {
    ...
    const filterCriteria = (student) => {
      ...
      if (
        student.stage_id !== parseInt(stage_id)
      ) {
        passesFilter = false;
      }
      return passesFilter;
    ...
    dispatch(filterGradeData({ key: form.values.key, filterCriteria: filterCriteria }));
...
//midGradeData, finalGradeData
  ...
  const keyOptions = [
    ...
    {
      value: "final",
      label: "درجات الدور الأول",
    },
    {
      value: "reFinal",
      label: "درجات الدور الثاني",
    },
  ];
  const statusOptions = [
    {
        ...
        <Flex direction="column" gap={10}>
          ...
          <SimpleGrid cols={2} spacing="sm">
            ...
            <Select
              ...
              data={keyOptions}
              onChange={(_value, option) => {
                form.setFieldValue("key", option ? option.value : null);
                handleSubmit();
              }}
